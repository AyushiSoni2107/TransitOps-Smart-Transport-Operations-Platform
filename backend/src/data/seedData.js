...
export const drivers = [
  ...
  { id: 'D006', name: 'Lena Muller', license: 'LIC-88760', licenseExpiry: '2026-12-31', phone: '+1-555-0106', status: 'On Duty', safetyScore: 99, assignedVehicle: 'TRUCK-8', totalTrips: 730, avatar: 'LM' }
];
...
export const trips = [
  ...
  { id: 'TR003', origin: 'Airport Hub', destination: 'Industrial Zone', driver: 'Lena Muller', vehicle: 'TRUCK-8', status: 'Completed', date: '2024-07-11', duration: '3h 00m', distance: '116 km' },
...
export const maintenanceRecords = [
  { id: 'M001', vehicle: 'BUS-12', service: 'Brake Pad Replacement', priority: 'High', date: '2024-07-15', mechanic: 'Shop A', cost: 0, status: 'Scheduled' },
  { id: 'M002', vehicle: 'TRUCK-3', service: 'Oil Change & Filter', priority: 'Medium', date: '2024-07-18', mechanic: 'Shop B', cost: 0, status: 'Scheduled' },
  { id: 'M003', vehicle: 'VAN-06', service: 'Tire Rotation', priority: 'Low', date: '2024-07-22', mechanic: 'Shop A', cost: 0, status: 'Scheduled' },
  { id: 'M004', vehicle: 'MICRO-05', service: 'Full Inspection', priority: 'High', date: '2024-07-14', mechanic: 'Shop C', cost: 0, status: 'In Progress' },
  { id: 'M005', vehicle: 'TRUCK-8', service: 'Engine Tune-up', priority: 'Medium', date: '2024-06-01', mechanic: 'Shop A', cost: 1240, status: 'Completed' },
  { id: 'M006', vehicle: 'BUS-12', service: 'Transmission Service', priority: 'High', date: '2024-05-20', mechanic: 'Shop B', cost: 3450, status: 'Completed' },
  { id: 'M007', vehicle: 'TRUCK-3', service: 'Brake Inspection', priority: 'Medium', date: '2024-05-15', mechanic: 'Shop B', cost: 420, status: 'Completed' },
  { id: 'M008', vehicle: 'MICRO-05', service: 'Battery Replacement', priority: 'Low', date: '2024-04-30', mechanic: 'Shop C', cost: 280, status: 'Completed' }
];

export const fuelLogs = [
  { id: 'FL001', vehicle: 'TRUCK-3', date: '2024-07-12', liters: 120, cost: 180, station: 'Shell A14', odometer: 98400 },
  { id: 'FL002', vehicle: 'BUS-12', date: '2024-07-11', liters: 200, cost: 300, station: 'BP Station', odometer: 210000 },
  { id: 'FL003', vehicle: 'TRUCK-8', date: '2024-07-10', liters: 150, cost: 225, station: 'Shell A14', odometer: 142000 },
  { id: 'FL004', vehicle: 'VAN-06', date: '2024-07-09', liters: 60, cost: 90, station: 'Esso Hub', odometer: 22100 },
  { id: 'FL005', vehicle: 'MICRO-05', date: '2024-07-08', liters: 45, cost: 67, station: 'Total M1', odometer: 55200 }
];
